...
**Tech Stack:** Dart 3.12, Flutter 3.44 or later, Material 3, Bloc, `sqflite` 2.4.3, `archive: ^4.0.9`, `file_picker: ^12.3.0`, Flutter localization, `sqflite_common_ffi`, Flutter unit and widget tests.
...
- Add no dependency beyond direct `archive: ^4.0.9` and `file_picker: ^12.3.0`.
...
- [x] **Step 1: Write failing use-case forwarding tests**
...
- [x] **Step 2: Plant and reject a boundary violation**
...
- [x] **Step 3: Add the contract and barrel export**
...
- [x] **Step 4: Add direct dependencies and resolve the graph**

Add `archive: ^4.0.9` and `file_picker: ^12.3.0` under `dependencies`.
Run `flutter pub get` and retain the regenerated `pubspec.lock` in the same change.

- [x] **Step 5: Verify the contract and dependency shape**
...
- [x] **Step 1: Build malformed fixtures and prove every guard RED**
...
- [x] **Step 2: Encode the exact envelope**
...
- [x] **Step 3: Decode without extracting paths**
...
- [x] **Step 4: Validate the manifest before returning database bytes**
...
- [x] **Step 5: Verify round trip and safe filename construction**
...
- [x] **Step 1: Write the pre-open schema tests**
...
- [x] **Step 2: Add the `singleInstance` path seam**
...
- [x] **Step 3: Enforce SQLite checks in order**
...
Compare every non-internal `sqlite_master` object with the current schema DDL, while allowing only the exact platform-maintained Android metadata table shape.
Close every raw and validated handle in `finally` paths.

- [x] **Step 4: Reconstruct every stored object**
...
- [x] **Step 5: Validate the latest recipe graph**
...
- [x] **Step 6: Prove validator reach and policy**
...
- [x] **Step 1: Prove the file seam's real semantics**
...
- [x] **Step 2: Add snapshot RED tests around the owned connection**
...
- [x] **Step 3: Checkpoint and acquire the exclusive transaction**
...
- [x] **Step 4: Validate the captured bytes before archive creation**
...
- [x] **Step 5: Make the consistency test sensitive**
...
- [x] **Step 1: Define the fault matrix before implementation**
...
- [x] **Step 2: Prove the unchanged-database assertion can fail**
...
- [x] **Step 3: Stage and validate the candidate without touching live files**
...
- [x] **Step 4: Close, protect, and replace in the specified order**
...
- [x] **Step 5: Recover without destroying diagnostic evidence**
...
- [x] **Step 6: Verify success and cleanup**
...
- [x] **Step 1: Test gateway orchestration and error mapping**
...
- [x] **Step 2: Implement one serialized gateway**
...
- [x] **Step 3: Write bootstrap RED tests**
...
- [x] **Step 4: Split one-time preparation from root construction**
...
- [x] **Step 5: Bind the active session and rebuild callback**
...
- [x] **Step 6: Carry a one-time restored notice into the fresh root**
...
- [x] **Step 1: Prove the picker adapter boundary RED**
...
- [x] **Step 2: Test size-before-read and cancellation behavior**
...
- [x] **Step 3: Write the cubit state-machine tests**
...
- [x] **Step 4: Implement the dialog and launcher**
...
- [x] **Step 5: Add the recipe-library commands without disturbing create**
...
- [x] **Step 6: Add complete English and Korean copy**
...
- [x] **Step 7: Prove responsive and state-preservation behavior**
...
- [x] **Step 1: Build a complete source library fixture**
...
- [x] **Step 2: Export from a live WAL database**
...
- [x] **Step 3: Restore into a different live library**
...
- [x] **Step 4: Compare complete persisted state**
...
- [x] **Step 5: Make the end-to-end comparison fail once**
...
- [x] **Step 1: Run scoped formatting and static checks**
...
- [x] **Step 2: Run full randomized tests and inspect what coverage reached**
...
- [x] **Step 3: Run Trunk on explicit changed paths**
...
- [x] **Step 4: Verify the iOS Simulator native picker flow**
...
- [x] **Step 7: Inspect final scope without mutating Git**
