...
void main() {
  ...
  test(
    'a proportional component only ever produces strictly positive '
    'quantities',
    () {
      final random = Random(20260906);
      for (var i = 0; i < 200; i++) {
  ...
  test(
    'a proportional component exact per-batch values sum to the base '
  ...
  test('rounding never lowers the displayed value', () {
    ...
    for (var i = 0; i < 100; i++) {
      ...
      expect(
        scaled.displayed.compareTo(scaled.exact),
