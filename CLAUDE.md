...
`lib/application/` holds one class per use case over the repository interfaces, and `lib/presentation/` holds three screens: the recipe library, the recipe editor, and production setup.
